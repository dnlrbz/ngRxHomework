...
let ResortsWidgetComponent = class ResortsWidgetComponent {
    ...
    ngOnInit() {
        ...
        this.store.select(state => {
            this.resortList = state.resorts;
            this.currResort = state.currentResort;
        });
    }
    changeResort(resort) {
...
let ResortEffects = class ResortEffects {
    constructor(actions, dataService) {
        ...
        this.dataService = dataService;
        this.loadResorts$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_6__["createEffect"])(() => this.actions.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_6__["ofType"])(_actions_resort_actions__WEBPACK_IMPORTED_MODULE_2__["requestResorts"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(() => this.dataService.getResorts()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((resorts) => Object(_actions_resort_actions__WEBPACK_IMPORTED_MODULE_2__["requestResortsSuccessful"])({ newResorts: resorts })), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(() => rxjs__WEBPACK_IMPORTED_MODULE_5__["EMPTY"])))));
    }
};
...
module.exports = __webpack_require__(/*! /Users/daniil/Downloads/ngHomework1-master/src/main.ts */"./src/main.ts");
